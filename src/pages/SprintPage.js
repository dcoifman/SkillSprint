    ...
    if (!currentStep) {
      ...
      return (
        <VStack spacing={6} align="stretch">
          <Heading size="lg" color={textColor}>Error Loading Content</Heading>
          <Text color={textLightColor}>There was a problem loading this step. Please try refreshing the page.</Text>
          <Button 
            as={RouterLink}
            to="/dashboard"
            colorScheme="blue" // Use new primary color scheme
            ...
            <AccordionPanel pb={4} borderTopWidth="1px" borderTopColor={borderColor}>
              <VStack spacing={4} align="stretch">
                <Text color={textLightColor}>
                  What questions do you have about "{currentStep?.title?.toLowerCase() || 'this step'}"?
                </Text>
