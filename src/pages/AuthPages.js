          ...
          <VStack as="form" onSubmit={handleSubmit} spacing={5} width="100%">
            ...
            <FormControl isInvalid={errors.terms}>
              ...
              >
                <Text fontSize="sm">
                  I agree to the{' '}
                  <Link as={RouterLink} to="/terms" color="primary.500" fontWeight="medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link as={RouterLink} to="/privacy" color="primary.500" fontWeight="medium">
                    Privacy Policy
                  </Link>
                </Text>
              </Checkbox>
          ...
          <Box width="100%">
            ...
            <HStack spacing={4}>
              ...
              <Button 
                ...
                leftIcon={
                  <Icon viewBox="0 0 24 24" width="20px" height="20px" color="#1877F2">
                    <path
                      fill="currentColor"
